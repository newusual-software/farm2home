      ...
      <div className="mx-auto w-full max-w-7xl px-8">
                ...
                <div>
                  <div className="relative mt-3">
                    <input
                      ...
                      className="py-3 px-4 pe-11 block w-full border-white border text-white shadow-sm rounded-lg text-sm  bg-transparent"
                  ...
                  <div className="my-2">
                    <button className="bg-lightGreen text-mainGreen w-[8rem] rounded-lg py-2 ">
                      Subscribe
                    </button>
                  </div>
                </div>
        ...
        <div className="flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          <div className="mb-4 text-center font-normal text-white md:mb-0">
            &copy; {currentYear}{" "}
            <a href="https://material-tailwind.com/">New Usual</a>. All Rights
            Reserved.
          </div>
        </div>
      </div>
